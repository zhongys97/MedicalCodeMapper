...
class ICD10CM_Coding19_Mapper():
    def __init__(self, coding19_csv_path, coding19_tree_hierarchy_path):
...
if __name__ == "__main__":
    ...
    mapper = ICD10CM_Coding19_Mapper(coding19_csv_path=CODING19_PATH, coding19_tree_hierarchy_path=TREE_FILE_PATH)
